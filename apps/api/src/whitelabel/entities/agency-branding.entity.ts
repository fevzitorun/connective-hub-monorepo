...
export class AgencyBranding {
  ...
  @Column({ name: 'hero_title', type: 'varchar', length: 255, nullable: true }) heroTitle: string | null
  ...
  @Column({ name: 'seo_title', type: 'varchar', length: 255, nullable: true }) seoTitle: string | null
  @Column({ name: 'seo_description', type: 'text', nullable: true }) seoDescription: string | null

  @Column({ name: 'custom_domain', type: 'varchar', length: 255, nullable: true }) customDomain: string | null
  @Column({ name: 'domain_verified', type: 'boolean', default: false }) domainVerified: boolean
  @Column({ name: 'domain_verify_token', type: 'varchar', length: 64, nullable: true }) domainVerifyToken: string | null
